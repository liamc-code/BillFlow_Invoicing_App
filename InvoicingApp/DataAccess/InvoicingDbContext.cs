...
namespace InvoicingApp.DataAccess
{
    public class InvoicingDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Seeding PaymentTerms data
            modelBuilder.Entity<PaymentTerms>().HasData(
                new PaymentTerms() { PaymentTermsId = 1, Description = "Net 10", DueDays = 10 },
                new PaymentTerms() { PaymentTermsId = 2, Description = "Net 20", DueDays = 20 },
                new PaymentTerms() { PaymentTermsId = 3, Description = "Net 30", DueDays = 30 },
            ...
            // Query filters for records flagged to be deleted
            modelBuilder.Entity<Customer>()
                .HasQueryFilter(c => !c.IsDeleted);

            modelBuilder.Entity<Invoice>()
                .HasQueryFilter(i => !i.Customer.IsDeleted);
            ...
            // Seeding Invoice Line Item data
